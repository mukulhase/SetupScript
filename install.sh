...
sudo apt-get install tmux imagemagick curl vim shutter openssh-server git zsh google-chrome-stable sublime-text-installer build-essential libssl-dev terminator;
